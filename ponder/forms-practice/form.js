...
form.addEventListener("submit", function (event) {
    ...
    if (type === "many" && note.length === 0) {
        output.textContent = "Please enter travel notes before submitting.";
        return;
    }
    ...
    // Let the user know to choose an availability date that is after the current date
